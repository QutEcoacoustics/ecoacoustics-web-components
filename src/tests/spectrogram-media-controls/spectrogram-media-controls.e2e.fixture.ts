...
class MultipleSpectrogramFixture {
  ...
  public async create() {
    await this.page.setContent(`
      <oe-spectrogram data-testid="spectrogram-one" id="first" src="${this.audioSource}"></oe-spectrogram>
      <oe-spectrogram data-testid="spectrogram-two" id="second" src="${this.audioSource}"></oe-spectrogram>
  ...
  public async createWithSameIds() {
    await this.page.setContent(`
      <oe-spectrogram data-testid="spectrogram-one" id="first" src="${this.audioSource}"></oe-spectrogram>
      <oe-spectrogram data-testid="spectrogram-two" id="first" src="${this.audioSource}"></oe-spectrogram>
      <oe-media-controls for="first"></oe-media-controls>
    `);
    await this.page.waitForLoadState("networkidle");
  }
